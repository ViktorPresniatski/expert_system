...
ActiveRecord::Schema.define(version: 20171109123909) do
  ...
  create_table "expert_questionnare_responses", force: :cascade do |t|
    ...
    t.index ["problem_request_id"], name: "index_expert_questionnare_responses_on_problem_request_id"
  end
  ...
  create_table "expert_responses", force: :cascade do |t|
    ...
    t.index ["problem_request_id"], name: "index_expert_responses_on_problem_request_id"
  end
